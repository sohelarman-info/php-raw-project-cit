      ...
      //logo updated msg
       ...
       ?>
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              ...
              <h6 class="card-body-title mg-b-20 text-center">Add Your Testimonials</h6>
              <form action="testimonials-post.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mg-t-20">
                  ...
                  <div class="col-sm-10 mg-t-10 mg-sm-t-0">
                    <textarea name="content" class="form-control" id="exampleFormControlTextarea3" rows="7" placeholder="What's On Your Mind?"></textarea>
                  </div>
                </div>
