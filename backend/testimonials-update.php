<?php include 'inc/header.php';
  ...
  $id           = $_GET['id'];
  $update       = "SELECT * FROM testimonials WHERE id = $id";
...
?>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="/backend">Starlight</a>
          ...
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <h6 class="card-body-title">Update Projects</h6>
                  <form action="testimonials-update-post.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="row mg-t-20">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <textarea class="form-control" id="exampleFormControlTextarea3" rows="7" name="content" placeholder="Enter Your Text Logo"><?= $after_assoc['content'] ?></textarea>
                  </div>
                </div>
