 	...
 	<!-- sl-pagebody Start-->
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40 mg-t-50">
          <h6 class="card-body-title">Users (<?php echo $active_user_assoc['total'] ?>)</h6>
          <p class="mg-b-20 mg-sm-b-30">All Active users list <span class="float-right"><a href="deactive-users.php">Deactive User (<?php echo $deactive_user_assoc['total'] ?>)</a></span></p>
